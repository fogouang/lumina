  ...
  <div class="min-h-screen bg-(--bg-ground)">
    ...
    >
      ...
      <div class="relative z-10 container mx-auto px-4">
        <div
          class="inline-flex items-center gap-2 bg-white/15 rounded-full px-4 py-1.5 text-white/90 text-sm font-medium mb-4"
        >
        ...
        <div
          ...
          class="inline-flex items-center gap-2 mt-5 bg-white/20 rounded-xl px-4 py-2"
        >
          ...
          <span class="text-white font-semibold text-sm">
            ...
            IA disponible{{ sub.aiCreditsRemaining > 1 ? "s" : "" }}
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-10 max-w-5xl">
      ...
      >
        <i
          class="pi pi-lock text-5xl text-(--text-tertiary) mb-4 block opacity-40"
        />
      ...
      <template v-else>
        ...
        <div
          ...
          class="mt-8 flex items-start gap-4 bg-amber-50 border border-amber-200 rounded-xl p-5 mb-8"
        >
          <i
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-amber-700 leading-relaxed">
              Vous pouvez lire les sujets mais pas lancer le simulateur avec
              correction. Achetez des crédits pour obtenir une correction en
              temps réel.
            </p>
          </div>
          <Button
        ...
        >
          <i
            class="pi pi-exclamation-circle text-5xl text-red-300 mb-4 block opacity-60"
          />
          <h2 class="text-xl font-bold text-(--text-primary) mb-2">
        ...
        >
          <i
            class="pi pi-calendar text-5xl text-(--text-tertiary) mb-4 block opacity-30"
          />
          <h2 class="text-xl font-bold text-(--text-primary) mb-2">
        ...
        <div
          v-if="!loading && !error"
          class="mb-5 mt-10 bg-(--bg-card) border border-(--border-color) rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center gap-4"
        >
          <div class="flex items-center gap-3 flex-1">
            <div
              class="w-12 h-12 rounded-xl bg-purple-50 flex items-center justify-center shrink-0"
            >
              <i class="pi pi-sparkles text-red-500 text-xl" />
            </div>
            <div>
              <p class="font-bold text-(--text-primary) mb-0.5">
                Comment fonctionnent les crédits IA ?
              </p>
              <p class="text-sm text-(--text-secondary) leading-relaxed">
                1 crédit = 1 correction IA complète (3 tâches). Chaque
                simulation consomme 1 crédit.
              </p>
            </div>
          </div>
          <Button
