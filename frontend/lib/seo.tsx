...
import { PlanListResponse } from "./api/models/PlanListResponse";
...
export const renderSchemaTags = (plans?: PlanListResponse[] | null) => {
  const baseSchema = {
  ...
  // Générer les offers depuis les plans actifs
  if (plans && plans.length > 0) {
    const offers = plans
      ...
      .map((plan) => ({
        ...
        priceCurrency: "XAF", // Franc CFA
        availability: "https://schema.org/InStock",
        // Optionnel : ajouter la validité de l'offre
  ...
  // Schema sans offers si pas de plans
  return (
    <script
      type="application/ld+json"
      dangerouslySetInnerHTML={{
